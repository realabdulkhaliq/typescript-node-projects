...
import inquirer from "inquirer"; // npm i inquirer then npm i -d @types/inquirer
import chalk from "chalk"; // npm i chalk
import showBanner from "node-banner"; // npm i node-banner
...
async function guessingNumber() {
    ...
    let answer = await inquirer.prompt([{ // it demands arrays of object
        // inquirer is an aysnc function thats why we need an async function to use it
        name: "userNumber",
        type: "number",
...
setTimeout(()=>{ // This is why our banner function is also an async function so we give dely to our guessingNumber Function
    guessingNumber();
},1000)

/*
Add a bin in package.json "bin": "./index.js"
Run npm login
NPM > Account > Packages
*/